...
grid.arrange(
  ...
  int.nexpmarg.ntr_pland %>% plot() + ggtitle("Pairwise interactions with strongest") + egg::theme_article() + theme(plot.title.position = "plot", axis.title.y = element_blank()),
  ncol = 2
)
```
...
grid.arrange(
  ...
  int.sedexpmarg.ann_agr_ed %>% plot() + ggtitle("Pairwise interactions with strongest") + egg::theme_article() + theme(plot.title.position = "plot", axis.title.y = element_blank()),
  ncol = 2
)
```
...
grid.arrange(
  ...
  int.qbmarg.prn_agr_para_mn %>% plot() + ggtitle("Pairwise interactions with strongest") + egg::theme_article() + theme(plot.title.position = "plot", axis.title.y = element_blank()),
  ncol = 2
)
```